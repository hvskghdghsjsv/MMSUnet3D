...
class MultiScaleMaskedTransformerDecoder3d(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        #!
        self.f_key = nn.Conv1d(in_channels=768,out_channels=192,kernel_size=1,stride=1)
    ...
    def forward(self, x, mask_features, l, mask = None):
        ...
        for i in range(self.num_feature_levels):
            ...
            pos.append(self.pe_layer(x[i], None).flatten(2)) # position embedding
        ...
        # QxNxC
        query_embed = self.query_embed.weight.unsqueeze(1).repeat(1, bs, 1) # p.e. 50,2,192
        ...
        if l is not None:
            ...
            output = self.query_feat.weight.unsqueeze(1).repeat(1, bs, 1) # todo 20,2,192
